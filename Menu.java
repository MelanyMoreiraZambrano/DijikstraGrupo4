...
public class Menu {
    ...
    public void menu(GrafoMatriz grafo) {
        ...
        switch (opcion) {
            ...
            case 7:
                ...
                System.out.println("------------------------------------------------");
                System.out.println("Ingrese el nombre origen del vertice:");
                String origenDijkstra = leer.nextLine();
                try {
                    grafo.dijkstra(origenDijkstra);
                    grafo.mostrarCaminoMinimo(origenDijkstra);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                menu(grafo);
    ...
    public void menuInfo () {
        ...
        System.out.println("Ingrese 7 Dijkstra");
        System.out.println("Ingrese 8 Salir");
        System.out.println("------------------------------------------------");
    }
}
